...
public:
    ...
    /**
     * @brief Permite rotar una imagen
     * @param angulo de rotación en radianes
     * @return objeto Imagen rotado
     */
    Imagen& rotar(double angulo, uint8_t opacidad=0xff);
    /**
     * @brief Permite superponer ... (no sé lo que haces hija mía)
     */
     ...
     * @param nombre_archivo
     */
    void leer(const char* nombre_archivo, const char* mascara);
    /**
     * @brief (otra función graciosa)
     * @param nombre_archivo
     */
    void escribir(const char* nombre_archivo, const string formato);
